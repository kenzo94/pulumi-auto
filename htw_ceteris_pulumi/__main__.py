...
blob_container_import = infra.createBlobContainer(cfg.blbContTargetImport,resource_group, account_destination) #'htw_container1'#cfg var
##  Create Blob Container for Archiv
blob_container_archiv = infra.createBlobContainer(cfg.blbContTargetArchiv,resource_group, account_destination) #'htw_container1'#cfg var
## Create Data Factory
...
## Save meta data into variable
#meta_table= db.get_meta_table(cfg.serverName,cfg.dbSourceName,cfg.dbSourceUserName,cfg.dbSourcePSW) #db.meta_table_10.copy()
